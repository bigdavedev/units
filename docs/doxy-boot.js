$( document ).ready(function() {
    ...
    $("span.icon:contains('N')").replaceWith('<span class="icon label label-primary">N</span>&nbsp');
    $("span.icon:contains('C')").replaceWith('<span class="icon label label-primary">C</span>&nbsp');
