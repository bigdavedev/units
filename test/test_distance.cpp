...
namespace TestDistanceUnits
{
	...
	{
		auto metric_to_imperial_lookup = std::unordered_map<std::type_index, double>{
		    // Imperial
	...
	{
		auto expected = TypeParam{conversion_tables::metric_to_imperial_lookup[std::type_index{typeid(TypeParam)}]};
