...
inline namespace literals
{
    ...
    {
        constexpr units::si::nanometres operator"" _nm(unsigned long long int dist)
        {
            return units::si::nanometres{static_cast<units::si::nanometres::rep>(dist)};
        }

        constexpr units::si::micrometres operator"" _um(unsigned long long int dist)
        {
            return units::si::micrometres{static_cast<units::si::micrometres::rep>(dist)};
        }

        constexpr units::si::millimetres operator"" _mm(unsigned long long int dist)
        {
            return units::si::millimetres{static_cast<units::si::millimetres::rep>(dist)};
        }

        constexpr units::si::centimetres operator"" _cm(unsigned long long int dist)
        {
            return units::si::centimetres{static_cast<units::si::centimetres::rep>(dist)};
        }

        constexpr units::si::decimetres operator"" _dm(unsigned long long int dist)
        {
            return units::si::decimetres{static_cast<units::si::decimetres::rep>(dist)};
        }

        constexpr units::si::metres operator"" _m(unsigned long long int dist)
        {
            return units::si::metres{static_cast<units::si::metres::rep>(dist)};
        }

        constexpr units::si::kilometres operator"" _km(unsigned long long int dist)
        {
            return units::si::kilometres{static_cast<units::si::kilometres::rep>(dist)};
        }
    }
}
